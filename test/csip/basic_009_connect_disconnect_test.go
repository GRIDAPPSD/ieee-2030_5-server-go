// CSIP V1.2 Section 8.9 - Inverter Control: Connect/Disconnect.
//
...
//
// V1.2 procedure step -> assertion mapping (per V1.2 Section 8.9):
//
...
// TestBASIC_009_ConnectDisconnect implements CSIP V1.2 Section 8.9.
