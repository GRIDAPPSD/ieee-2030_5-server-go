// CSIP V1.2 section 5.6 - List Handling.
//
// Procedure (paraphrased; full text in V1.2 PDF section 5.6):
//
...
// TestCORE_004_ListHandling exercises CSIP V1.2 section 5.6 against a live
...
func TestCORE_004_ListHandling(t *testing.T) {
	...
	t.Run("start_and_limit", func(t *testing.T) {
		t.Parallel()
		// V1.2 section 5.6 step: GET /edev?s=0&l=10 -> up to 10 items, starting
	...
	t.Run("start_offset", func(t *testing.T) {
		t.Parallel()
		// V1.2 section 5.6 step: GET /edev?s=1 -> skip the first item.
	...
	t.Run("limit_zero_returns_empty", func(t *testing.T) {
		t.Parallel()
		// V1.2 section 5.6 edge: GET /edev?l=0 -> zero items, but All still
	...
	t.Run("after_key_returns_strictly_greater", func(t *testing.T) {
		t.Parallel()
		// V1.2 section 5.6 step: GET /edev?a=0 -> return items whose store key
	...
	t.Run("duplicate_limit_first_value_wins", func(t *testing.T) {
		t.Parallel()
		// V1.2 section 5.6 + Go net/url.Values.Get convention: when the same
	...
	t.Run("unknown_param_ignored", func(t *testing.T) {
		t.Parallel()
		// V1.2 section 5.6 step: unknown query parameters are ignored.
