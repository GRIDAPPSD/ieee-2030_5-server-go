...
func TestBootFixtureWiringGCM(t *testing.T) {
	...
	// Use the self-minted test device fixture vendored in the repo. The
	// fixture path is resolved relative to the repo root; tests run from
	// the internal/server package dir, so go up two levels.
