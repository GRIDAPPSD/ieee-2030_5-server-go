...
// CSIP V1.2 section 11.6 - Subscription Terminate (Server Refuses Retry).
//
...
// TestMAINT_006_SubscriptionTerminate implements CSIP V1.2 section 11.6.
func TestMAINT_006_SubscriptionTerminate(t *testing.T) {
	...
	owner := csiptest.NewDeviceIdentity(t, "MAINT-006-DEVICE")
	srv := csiptest.BootServer(t, csiptest.WithDeviceIdentity(owner))
	seedOwnedEndDevice(t, srv.Stores.EndDevices, maint006EndDeviceID, owner)
