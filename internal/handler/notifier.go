...
//
// Moved from edev.go to this file in Phase 3 (IEEESRV-003) so the
// interface survives the deletion of the protocol handler files while
// admin and mutation callers (assembly_seam.go, test_mutations.go,
// csiptest/server.go) keep their existing import paths.
